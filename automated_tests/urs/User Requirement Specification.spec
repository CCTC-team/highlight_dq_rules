...
E.124.1200 - The system shall support the ability to view excluded data quality rules in instruments based on user roles using Highlight DQ Rules external module.
E.124.1300 - The system shall support the ability to configure 'Module configuration permissions in projects' for Highlight DQ Rules external module.
E.124.1400 - The system shall record every configuration change (who changed which setting, when, and from what value to what) for the Highlight DQ Rules external module to the module's View Logs page.